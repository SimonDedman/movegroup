...
write.csv(md,
          file = paste0(data.dir, out.dir, "Lemons_VolumeArea_AbsoluteScale.csv"),
          row.names = FALSE
)
...
ggmap(myMap) +
  ...
  scale_colour_manual(name = "Percent UD Contours", values = c(KUD_95_pct = "red", KUD_50_pct = "orange")) +
  ggtitle("50% and 95% contours, lemon sharks, Bimini",
          subtitle = "contours all scaled. n = 13") +
...
ggsave(paste0(today(), "_dBBMM-Homerange-95-50pct-UDs.png"),
