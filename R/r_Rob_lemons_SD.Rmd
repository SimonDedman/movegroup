...
ggmap(myMap) +
  ...
  # breaks = c(0.5, 0.95)
  # Warning: Incompatible methods ("+.gg", "Ops.data.frame") for "+" Error in ggmap(myMap) + st_contour(lemons.ras) : non-numeric argument to binary operator. Same for ggmap, with default contour_lines & breaks
  # geom_sf(data = crop_map, colour = "black", fill = "grey") + # coastline basemap # REMOVE if using GGMAP
