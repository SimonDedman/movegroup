...
# googlemap = TRUE # set as top parameter when this is a function
...
ggmap(myMap) +
  ...
  geom_sf(data = st_contour(x = lemons.ras,
          ...
          aes(colour = "KUD_95_pct")) + # https://github.com/dkahle/ggmap/issues/160#issuecomment-966812818
  geom_sf(data = st_contour(x = lemons.ras, contour_lines = TRUE, breaks = c(0.5)) %>%
            st_transform(3857), fill = NA, inherit.aes = FALSE, aes(colour = "KUD_50_pct")) +
  scale_colour_manual(name = "Percent KUD Contours", values = c(KUD_95_pct = "red", KUD_50_pct = "orange")) +
...
ggsave(paste0(work.dir, out.dir, "Scaled/", today(), "_dBBMM-Homerange-95-50pct-KUDs.png"),
       plot = last_plot(), device = "png", path = "", scale = 1,
