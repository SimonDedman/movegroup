...
#' file.path(movegroupsavedir, "Scaled/All_Rasters_Scaled_Weighted_LatLon.asc").
...
plotraster <- function(
    ...
    xlatlon = NULL, # if you want to also return a csv of your original locations labelled with which UD contours they fall within, include the location of that here. Try file.path(crsloc, "Scaled/All_Rasters_Scaled_Weighted_LatLon.asc") .
