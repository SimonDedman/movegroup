...
for (i in unique(DET$Tag)) {
  ...
  # create move object
  move.i <- move(
    x = DET.i$Lon, y = DET.i$Lat, time = DET.i$Datetime,
  ...
  e <- 80 * 1000
  xUTM.i <- raster(
    xmn = min(DET.i$NewEastingUTM) - e, xmx = max(DET.i$NewEastingUTM) + e, ymn = min(DET.i$NewNorthingUTM) - e,
  ...
  x.i <- raster(
    xmn = min(DET.i$NewEastingUTM), xmx = max(DET.i$NewEastingUTM), ymn = min(DET.i$NewNorthingUTM),
  ...
  bursted_dbbmm <- brownian.bridge.dyn(bursted,
    burstType = "normal", raster = xAEQD.i,
...
if (!dir.exists(paste(data.dir, out.dir_h, sep = ""))) {
  stop(paste0(
    "Directory not found: \n",
...
if (!dir.exists(paste(data.dir, out.dir_l, sep = ""))) {
  stop(paste0(
    "Directory not found: \n",
...
if (!dir.exists(paste(data.dir, out.dir_m, sep = ""))) {
  stop(paste0(
    "Directory not found: \n",
